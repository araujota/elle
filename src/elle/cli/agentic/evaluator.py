...
# =============================================================================
# SufficiencyEvaluator (Legacy - Backwards Compatible)
# =============================================================================
...
class SufficiencyEvaluator:
    ...
    DEPRECATED: Use GoalEvaluator for new code. This is kept for
    backwards compatibility with the legacy GatherResult.
    """
...
def get_evaluator() -> SufficiencyEvaluator:
    """Get the shared evaluator instance (legacy).
...
def reset_evaluator() -> None:
    """Reset the shared evaluator instances."""
    global _evaluator, _goal_evaluator
    _evaluator = None
